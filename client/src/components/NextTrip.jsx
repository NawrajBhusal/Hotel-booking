...
const NextTrip = () => {
  const trips = [
    {
      image: Image1,
      title: "Nepal’s 10 most fashionable 5 star hotels",
      description:
        "Browse the fastest growing tourism sector in the heart of Nepal's tourism capital ....",
    },
    {
      image: Image2,
      title: "Top places for Jungle Safari",
      description:
        "Top places where you do not have to worry about Wildlife. Our tourist guide is here...",
    },
    {
      image: Image3,
      title: "Nepal’s top destinations",
      description:
